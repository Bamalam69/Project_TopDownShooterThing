namespace DynamicLight2D
{
		...
		public class DynamicLight : MonoBehaviour {
				...
				/// <summary>
				/// Flag: Perform an persistent callback every loop to check if exist casters within sight of current 2DLight. "Require useEvents = true"
				/// </summary>
...
//				#endif
		...
		private void initMeshFilterAndRenderer(){
			...
			// ------------- TYPE OF LIGHT ---------------------- //
					...
					if (light2DType == Light2DType.PreBaked && Application.isPlaying)
